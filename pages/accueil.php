...
<div id="wrap_accueil">
    <div class="categorie_accueil">
        ...
        <div class="onglets_accueil">
            ...
            <a href="index.php?page=referencement">En savoir plus sur le Référencement</a>
        </div>
    </div>
    ...
    <div class="categorie_accueil">
        ...
        <div class="onglets_accueil">
            ...
            <a href="index.php?page=outils">Accéder aux Outils</a>
        </div>
    </div>
    ...
    <div class="categorie_accueil">
        ...
        <div class="onglets_accueil">
            ...
            <a href="index.php?page=infos_consommateur">Lire les Infos consommateurs</a>
        </div>
    </div>
